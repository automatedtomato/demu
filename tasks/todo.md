...
Milestone: [Release v0.1.0](https://github.com/automatedtomato/demu/milestone/1)
...
- [x] [#6](https://github.com/automatedtomato/demu/issues/6) feat: REPL — custom inspection commands (`:layers`, `:history`) — PR [#15](https://github.com/automatedtomato/demu/pull/15)
- [x] [#7](https://github.com/automatedtomato/demu/issues/7) feat: CLI entrypoint — parser → engine → warnings → REPL
